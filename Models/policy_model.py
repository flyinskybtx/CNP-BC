...
from Data.cartpole_data import PolicyDataGenerator, PolicyData
...
def build_fc_model(obs_space: gym.Space, action_space: gym.Space, hiddens, with_values=True, name='fc_model'):
    ...
    logits = tf.keras.layers.Dense(action_space.shape, activation=None,
